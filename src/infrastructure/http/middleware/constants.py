...
ACCESS_TOKEN_DELIVERED_VIA_COOKIE: Final[str] = "Delivered auth session token via cookie."
ACCESS_TOKEN_INVALID_OR_EXPIRED: Final[str] = "Invalid or expired JWT."
ACCESS_TOKEN_MARKED_FOR_REMOVAL: Final[str] = "Marked access token for removal in response."
