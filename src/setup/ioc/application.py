...
from common.adapter.main_transaction_manager_sqla import \
...
from features.user.domain.core.service.current_user_service import \
    CurrentUserService
from features.user.domain.port.inbound.activate_user_use_case import \
    ActivateUserUseCase
...
from features.user.domain.port.inbound.grant_admin_use_case import \
    GrantAdminUseCase
